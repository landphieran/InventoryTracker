...
import com.andrew.store.StoreFactory;
	...
	public void execute() {
		...
		try {
			for (Map.Entry<String, String> entry : filters.entrySet()) {
				...
				//TODO Convert to input stream/Copy List/clear old list/Thread 
				//TODO This should save to a DB
				StoreFactory.getStore(entry.getKey()).execute(result_messages.parallelStream());
			}
		} catch (IOException e) {
